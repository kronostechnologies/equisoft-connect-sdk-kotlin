...
class MovementApi(
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun cancelMovementWithHttpInfo(movementId: kotlin.Int) : ApiResponse<kotlin.Any?> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun deleteMovementWithHttpInfo(movementId: kotlin.Int) : ApiResponse<kotlin.Any?> {
