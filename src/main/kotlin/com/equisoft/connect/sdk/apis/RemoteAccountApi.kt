...
class RemoteAccountApi(
    ...
    */
    ...
    fun synchronizeCalendars(dateTimeStart: kotlin.String?, dateTimeEnd: kotlin.String?, webuserCalendarIds: kotlin.collections.List<kotlin.Int>?, remoteFolderIds: kotlin.collections.List<kotlin.Int>?, webuserIds: kotlin.collections.List<kotlin.Int>?) : RemoteaccountAccountSyncResponse {
        ...
        val localVarResponse = request<RemoteaccountAccountSyncResponse>(
            localVariableConfig
        )
    ...
    */
    fun synchronizeCalendarsRequestConfig(dateTimeStart: kotlin.String?, dateTimeEnd: kotlin.String?, webuserCalendarIds: kotlin.collections.List<kotlin.Int>?, remoteFolderIds: kotlin.collections.List<kotlin.Int>?, webuserIds: kotlin.collections.List<kotlin.Int>?) : RequestConfig {
    ...
    * @return RequestConfig
    */
    fun synchronizeTasksRequestConfig(dateTimeStart: kotlin.String?, dateTimeEnd: kotlin.String?, webuserCalendarIds: kotlin.collections.List<kotlin.Int>?, remoteFolderIds: kotlin.collections.List<kotlin.Int>?, webuserIds: kotlin.collections.List<kotlin.Int>?) : RequestConfig {
        val localVariableBody: kotlin.Any? = mapOf("dateTimeStart" to dateTimeStart, "dateTimeEnd" to dateTimeEnd, "webuserCalendarIds" to webuserCalendarIds, "remoteFolderIds" to remoteFolderIds, "webuserIds" to webuserIds)
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf("Content-Type" to "application/x-www-form-urlencoded")
