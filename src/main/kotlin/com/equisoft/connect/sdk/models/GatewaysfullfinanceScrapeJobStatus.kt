...
enum class GatewaysfullfinanceScrapeJobStatus(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is GatewaysfullfinanceScrapeJobStatus) "$data" else null

        /**
         * Returns a valid [GatewaysfullfinanceScrapeJobStatus] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): GatewaysfullfinanceScrapeJobStatus? = data?.let {
