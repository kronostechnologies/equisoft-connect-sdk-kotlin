...
import equisoft/openapi.models.GatewaysListCredentialsResponse
import equisoft/openapi.models.GatewaysaccessesAdminCredentialsResponse
import equisoft/openapi.models.GatewaysaccessesCreateAccessResponse
import equisoft/openapi.models.GatewaysaccessesCreateEquisoftAnalyzeAccessPayload
import equisoft/openapi.models.GatewaysaccessesListGatewayAccessesResponse
import equisoft/openapi.models.GatewaysaccessesPatchEquisoftAnalyzeAccessPayload
import equisoft/openapi.models.GatewaysaccessesvalidationCredentialsResponse
...
class GatewaysApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun gatewayAdminLogin(gatewayName: kotlin.String) : GatewaysaccessesAdminCredentialsResponse {
        val localVariableConfig = gatewayAdminLoginRequestConfig(gatewayName = gatewayName)
    ...
    * @return RequestConfig
    */
    fun gatewayAdminLoginRequestConfig(gatewayName: kotlin.String) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun gatewayCredentials(gatewayId: kotlin.String, status: kotlin.String) : GatewaysaccessesvalidationCredentialsResponse {
        val localVariableConfig = gatewayCredentialsRequestConfig(gatewayId = gatewayId, status = status)
    ...
    * @return RequestConfig
    */
    fun gatewayCredentialsRequestConfig(gatewayId: kotlin.String, status: kotlin.String) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
